...
export const Hero: React.FC = () => {
  ...
  return (
    <div>
      ...
      <section
        ref={heroRef}
        className="bg-white pt-16 pb-24 md:pt-20 md:pb-28"
      >
        <div className="container mx-auto px-6 md:px-12">
          <div className="md:flex items-center">
            ...
            <div className="w-full md:w-[478px]">
              ...
              {/* 
                text-3xl on very small screens,
                text-5xl on small (sm) screens and above,
                text-7xl on medium (md) screens and above 
              */}
              <h1 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tighter bg-gradient-to-b from-black to-gray-700 text-transparent bg-clip-text mt-6 leading-tight">
              ...
              {/* 
                ...
                text-xl on medium screens and above
              */}
              <p className="text-base sm:text-lg md:text-xl text-[#010D3E] tracking-tight mt-6">
                Unleash a smarter way to grade! Our AI-powered grading system
                provides quicker, fairer, and more insightful evaluations,
                allowing educators to focus on what matters most—helping students
                succeed.
              </p>
              {/* Buttons: stacked on mobile, side-by-side on small+ */}
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center mt-8">
                ...
                <button
                  className="btn btn-text flex items-center gap-2 w-full sm:w-auto"
            ...
            {/* Right Side: Image */}
            <div className="mt-12 md:mt-0 md:h-[648px] md:flex-1 relative">
              <motion.img
                src={student_1.src}
                alt="Student Illustration"
                className="md:absolute md:h-full md:w-auto md:max-w-none"
                animate={{ translateX: [-20, 20] }}
                transition={{
                  duration: 10,
                  repeat: Infinity,
                  repeatType: "mirror",
      ...
      {/* Backed by Section */}
      <section className="py-16 bg-white flex flex-col items-center justify-center p-6 rounded-lg shadow-lg">
        <div className="flex items-center gap-1">
          {/* 
            Smaller heading on mobile, bigger on sm+
          */}
          <span className="text-3xl sm:text-5xl text-orange-500 font-bold">
            Backed
          </span>
          <span className="text-3xl sm:text-5xl text-black font-bold">by</span>
        </div>
        <Image
          src={msuLogo}
          alt="MSU Logo"
      ...
      <section className="relative bg-white py-24 overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-gray-800 mt-2 leading-tight">
              <span className="text-orange-500">Why</span>
              <span className="text-black"> Choose</span>
              <span className="text-orange-500"> Smart</span>
              <span className="text-black">Paths?</span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-black tracking-tight mt-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className={`feature-card p-6 ${feature.bgColor} text-gray-800 rounded-lg shadow-lg border ${feature.borderColor} transform transition-transform hover:scale-105`}
              >
                <Image
                  src={feature.image}
                  alt="Feature Image"
      ...
      <section className="bg-white py-24 relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="section-title text-3xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-gray-800 mt-2 leading-tight">
              <span className="text-orange-500">Our</span>
              <span className="text-black"> Exclusive Premiere Feature</span>
            </h2>
            <p className="section-description text-lg sm:text-xl md:text-2xl text-black tracking-tight mt-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="metric-card p-6 bg-white rounded-lg shadow-lg transform transition-transform hover:scale-105">
                <Image
                  ...
                  className="mx-auto mb-4"
                />
                <h3 className="text-xl sm:text-2xl font-bold mb-2 text-center text-gray-800">
                  Accuracy Rate
                </h3>
                <p className="text-gray-800 text-2xl sm:text-3xl md:text-4xl font-bold text-center">
                  98%
                </p>
              </div>
              <div className="metric-card p-6 bg-white rounded-lg shadow-lg transform transition-transform hover:scale-105">
              ...
              <div className="metric-card p-6 bg-white rounded-lg shadow-lg transform transition-transform hover:scale-105">
                <Image
                  src={biasReductionIcon}
                  alt="Bias Reduction Icon"
                  width={100}
                  height={100}
                  className="mx-auto mb-4"
                />
      ...
      <section className="bg-white py-14 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tighter text-black leading-tight">
        ...
        <div className="container mx-auto px-6">
          <div className="relative text-center mb-10">
            ...
            <p className="mt-5 text-base sm:text-lg md:text-xl text-gray-600">
              Sign up for{" "}
              <span className="text-orange-500 font-bold">Smart</span>
              <span>Paths</span> today and streamline your evaluation process
              like never before.
            </p>
            <motion.div
